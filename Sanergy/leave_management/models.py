...
class EmployeeLeaveRequest(models.Model):
    Id = models.CharField(primary_key=True, null=False, max_length=100, unique=True, blank=True)
    # employee = models.ForeignKey(Employee, blank=False, null=True, on_delete=models.DO_NOTHING)
    leave_type = models.CharField(max_length=400, blank=False, null=True)
    leave_start_date = models.DateField(max_length=400, blank=False, null=True)
    leave_end_date = models.DateField(max_length=400, blank=False, null=True)
    ...
    no_of_leave_days_requested = models.DecimalField(decimal_places=2,max_digits=2, blank=False, null=True)
    ...
    startEndDate = models.DateField(max_length=400, blank=False, null=True)
