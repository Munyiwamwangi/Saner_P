    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Sanergy_Department', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='leave_management.SanergyDepartment')),
                ('Sanergy_Department_Unit', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='leave_management.SanergyDepartmentUnit')),
